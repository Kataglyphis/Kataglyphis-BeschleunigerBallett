...
Kataglyphis::File::File(const std::string &file_location)
    : Kataglyphis::Shared::FileLocationHolder(file_location)
{}
...
{
    return Kataglyphis::Shared::getBaseDir(get_file_location());
}
