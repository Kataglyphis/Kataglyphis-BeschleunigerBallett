...
// mean blend samples lit by two different lights. Deliberately narrow -
// cloud/shadow/PCF fields in SceneUBO are not read by path_tracing.slang, so
// widening this to the whole UBO would reset on changes that do not affect
// the traced image.
