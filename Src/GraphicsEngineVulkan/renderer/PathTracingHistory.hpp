...
// path_tracing.slang's NEE terms (:227, :253-255) read sceneUBO.dirLight and
// a light change makes the running mean blend samples lit by two different
// lights. Deliberately narrow - cloud/shadow/PCF fields in SceneUBO are not
